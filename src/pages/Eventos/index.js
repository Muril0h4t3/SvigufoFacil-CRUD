                ...
                <ul>
                    {
                        this.state.listaEventos.map((evento, key) => {
                            return (
                                <li key={key}>
                                    {evento.id} - {evento.titulo} - {evento.descricao} - {evento.data} -  {evento.acessoLivre.toString()} - <button id={evento.id} onClick={this.buscarPorId.bind(this)}>Editar</button> - <button id={evento.id} onClick={this.excluirPorId.bind(this)}>Excluir</button>
                                </li>
                            )
                        })
                    }
